...
class Bank
{
    ...
    protected float Loan_Interest_Rate;
    protected Double Saving_Interest_Rate;
    protected Double CreditLimit;
    protected SavingAccount SA;
    protected CheckingAccount CA;
    protected loanAccount LA;
    ...
    public Bank()
    {
        ...
        Loan_Interest_Rate = 5.0f;
        Saving_Interest_Rate = 5.0;
        CreditLimit = 5000.00;
        SA = null;
        CA = null;
        LA = null;
